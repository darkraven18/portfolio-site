...
function MenuOptions({ toggleMenu, option }) {
    ...
    return (
        <a href={link} onClick={buttonClick} className={option === 'Resume' ? 'p-2 border-solid border-2 border-green hover:border-white transition duration-600 ease-in-out hover:scale-110' : 'hover:scale-110 transition duration-600'}>
